...
function setupEditors() {
    ...
    if (textareas.some(el => !el)) {
        console.warn('Some editor textareas were not found:', {
            def: !!Elements.defInput,
            char: !!Elements.charInput,
            ex: !!Elements.exInput,
            nonEx: !!Elements.nonExInput
        });
    }
    ...
    textareas.forEach(textarea => {
        ...
        console.log('Creating toolbar for', textarea.id);
